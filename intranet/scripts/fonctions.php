...
function parametres($titre)
{
    ...
    <head>
        ...
        <link rel="icon" type="image/jpeg" href="scripts/logomini.png">
...
function navigation()
{
    ...
    <nav class="navbar navbar-expand-lg border-bottom bg-black p-3 shadow-sm" data-bs-theme="dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="accueil_intranet.php">
                <img src="scripts/logo.jpeg" alt="Hostbook Logo" style="max-height: 40px;">
            </a>
    ...
    if (isset($_SESSION['pseudo'])) {
        echo '<li class="nav-item"><a class="nav-link ' . ($page_active == 'accueil_intranet.php' ? 'active hostbook-accent fw-bold' : 'text-light fw-semibold') . ' px-3" href="accueil_intranet.php">Tableau de bord</a></li>';
        echo '<li class="nav-item"><a class="nav-link ' . ($page_active == 'partage.php' ? 'active hostbook-accent fw-bold' : 'text-light fw-semibold') . ' px-3" href="partage.php">Fichiers Partagés</a></li>';
        echo '<li class="nav-item"><a class="nav-link ' . ($page_active == 'annuaire_employe.php' ? 'active hostbook-accent fw-bold' : 'text-light fw-semibold') . ' px-3" href="annuaire_employe.php">Annuaire Employés</a></li>';
    ...
    echo '<li class="nav-item"><a class="nav-link ' . ($page_active == 'wiki.php' ? 'active hostbook-accent fw-bold' : 'text-light fw-semibold') . ' px-3" href="wiki.php">Wiki</a></li>';
    ...
    if (isset($_SESSION['pseudo'])) {
        ...
        echo '<span class="me-3 text-light small">Connecté en tant que ' . htmlspecialchars($_SESSION['pseudo']) . ' (' . htmlspecialchars($groupe) . ')</span>';
